...
import EnrollFormStepOne from '../components/foreigner/initial';
import EnrollFormPersonalInfo from '../components/foreigner/personalInfo';
import EnrollFormDiseaseInfo from '../components/foreigner/disease';
import EnrollFormJobInfo from '../components/foreigner/jobs';
import EnrollFormAddressInfo from '../components/foreigner/address';
// import EnrollFormCenterInfo from './../components/foreigner/center';
import EnrollFormOtpVerify from '../components/foreigner/otp_verify';
import { EnrollProvider } from '../contexts/enroll';
import { saveForeignerVaccineEntry } from '../services/enroll';
    ...
    const onSubmit = (data) => {
        const finalFormData = {
            ...
            ...{
                ...
                dose_given_date_1: `${enrollmentInfo.vaccination_month ? enrollmentInfo.vaccination_month : ''}/${enrollmentInfo.vaccination_day ? enrollmentInfo.vaccination_day : ''}/${enrollmentInfo.vaccination_year ? enrollmentInfo.vaccination_year : ''}`,
                mobile: data.mobile
            }
        };
        ...
        setDisableSubmittedBtn(true);
        setFormLoading(true);
        saveForeignerVaccineEntry(finalFormData).then((response) => {
            console.log('saveForeignerVaccineEntry', response);
            ...
            if (response.response.result) {
                ...
                props.history.push({
                    pathname: "/foreigners-otp-verify",
                ...
                <div className="container">
                    <div className="row text-left">
                        <div className="col-12">
                            <h3>{t('form.title-foreigner-enroll')}</h3>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        />
                            {/* <ul>
                            {
                                ...
                                <Fragment>
                                    ...
                                    <li><NavLink className={showForm ? "activated" : ""} to="/enroll/foreigners?s=1">{t("form.label.passport")}</NavLink></li>
                                </Fragment>
                            }
                            </ul> */}
                        </div>
                            ...
                            <div className="su-enroll-form-main card-body p-0 enroll-container-wrappwer">
                                {
                                    showForm ?
                                        <Fragment>
                                            <EnrollProvider value={{ enrollmentInfo, setEnrollmentInfo, passportInfo, setPassportInfo, register, errors, handleSubmit, setValue, trigger, tempRegistrationId, setTempRegistrationId, errorMsg, setErrorMsg, Controller, control, setDisableLeftNavMenu }}>
                                                    ...
                                                    <div className="container form-section-wrapper" id="step8">
                                                        <div className="d-flex border-top py-3 mr-10 ml-10">
                                                            ...
                                                            <div className="checkbox-inline">
                                                                ...
                                                                <input type="checkbox" name="agree" onChange={onAgreementChecked} ref={register()} value="1" id="agree" checked={!disableSubmittedBtn} required />
