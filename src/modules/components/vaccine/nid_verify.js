                        ...
                        <div id="su-reg-status-form">
                            <div className="row">
                                <div className="col-md-6 mb-4">
                                    ...
                                    />
                                    {errors.nid &&
                                    <div className="su-alert-phone">{t('form.error.nid-number-invalid')}</div>}
                                </div>
                                ...
                                <div className="col-md-6 mb-4">
                                    ...
                                    {(errors.dob_day || errors.dob_month || errors.dob_year) && <div className="su-alert-phone">{t('form.error.no-dob')}</div>}
                                </div>
                            </div>
                                ...
                                <div className="row align-items-center">
                                    <div className="col-md-6">
                                        <div className="form-group fv-plugins-icon-container has-success">
                                            ...
                                            {errors.otp &&
                                            <div className="fv-help-block">{t('form.error.otp-empty')}</div>}
                                        </div>
                                    </div>
