...
const VaccineCardBirthReg = (props) => {
                  ...
                  >
                    ...
                    <div style={{ float: "left", width: "460px" }}>
                      <div style={{ float: "left", width: "460px" }}>
                        ...
                        >
                          {props.data.birth_reg_no ? props.data.birth_reg_no : <span>&nbsp;</span>}
                        </div>
                      </div>
                    </div>
                        ...
                        <span>
                          <QRCode
                            value={JSON.stringify({
                              birth_reg_no: props.data.birth_reg_no,
                              registration_id: props.data.registration_id,
                            })}
                            size={80}
                          />
                        </span>
...
export default VaccineCardBirthReg;
